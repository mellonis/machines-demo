...
- Machine toolchains wasm bundle (`mtc-wasm`, pinned by tag and checksum; fetched on install into a gitignored vendor directory) — TM-1 / PM-1 compile, assemble, lint, format, tape-block codec, and a pumped run session, all in a Web Worker
